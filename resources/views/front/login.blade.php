                            ...
                            <div class="col-10 col-md-9 col-lg-5 col-xl-5">
                                ...
                                <form action="" id="login-form"  class="needs-validation" novalidate>
                                    ...
                                    <div class="form-group align-center">
                                        ...
                                        <input type="password" class="form-control form-control-lg" id="paswordInput" required>
                                    </div>
                                ...
                                <div class="extra-info">
                                    <p class="forgot-pwd align-center"><a href="forget-password.php">Lost your password?</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
