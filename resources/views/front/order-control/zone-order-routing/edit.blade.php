...
@section('page-title',"Zone Routing Edit")
                ...
                <div class="row no-gutters">
                    ...
                    <aside id="right_content" class="col-12 col-lg-9">
                        <div class="inner">
                            ...
                            <form method="POST" action="{{ route('order_zone_routing.update', $orderZoneRouting) }}"
                                  id="account-form"
                                    ...
                                    <div class="section-inner">
                                        <div class="form-row">
                                            <div class="form-group col-12 col-md-4 no-min-h">
                                                ...
                                                <input type="text" class="form-control form-control-lg"
                                                       ...
                                                       value="{{ $orderZoneRouting->title }}" required>
                                                @if ($errors->has('title'))
                                                ...
                                                <select name="zone_type_id" id="" class="form-control form-control-lg"
                                                    ...
                                                    @foreach($zoneTypes as $zoneType)
                                                        <option value="{{$zoneType->id}}"
                                                                {{ ($orderZoneRouting->zone_type_id == $zoneType->id) ? 'selected' : '' }}>
                                                            {{$zoneType->title}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group col-12 col-md-4 no-min-h">
                                                ...
                                                <select name="hub_id" id="" class="form-control form-control-lg"
                                                    ...
                                                    @foreach($hubs as $hub)
                                                        <option value="{{$hub->id}}"
                                                                {{ ($orderZoneRouting->hub_id == $hub->id) ? 'selected' : '' }}>
                                                            {{$hub->title}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row fieldGroup">
                                            ...
                                            <div class="form-group col-md-4 no-min-h">
                                                @foreach($orderZoneRouting->postalCode as $key => $postalCode)
                                                    <input type="text" class="form-control form-control-lg mt-3"
                                                           placeholder="Enter Postal Code" id="postal_code"
                                                           name="postal_code[]" value="{{ $postalCode->postal_code }}">

                                                @endforeach

                                            </div>
                                            <div class="input-group-addon col-md-2 mt-3">
