            ...
            <div class="portlet-body">
                ...
                <form method="POST" action="{{ route('users.edit-profile') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="first_name" maxlength="32" value="{{  $data->full_name  }}" class="form-control" />
                     ...
                     {{--   <label for="last_name" class="col-md-2 control-label">Last Name *</label>
                        ...
                        <div class="col-md-4">
                            <input type="text" name="email" maxlength="128" value="{{  $data->email }}" class="form-control" readonly />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="username" class="col-md-2 control-label ">Phone </label>
                        <div class="col-md-4">
                            <input type="text" name="phone" maxlength="24" value="{{  $data->phone }}" class="form-control phone_us" />
                        </div>
