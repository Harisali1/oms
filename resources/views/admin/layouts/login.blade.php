...
<head>
   ...
   <link rel="shortcut icon" href="{{ asset('assets/front/assets/images/logo.jpg') }}"/>
...
<body class="login" {{--style="background-size: cover;background-image:url({{ asset('assets/admin/joeyco-theme.jpg') }})"--}}>
    ...
    <div class="content logo text-align-left" style="margin-top: 150px;">
        <a href="{{ route('login') }}">
            <img src="{!! asset('assets/front/assets/images/logo.jpg') !!}" alt="Web Builder" class="img-responsive" style="margin:0 auto; width:150px;" />
        </a>
    </div>
    <!-- END LOGO -->
